...
class ContinualFiveLanguage(Dataset):
    ...
    def build_meta_data(self, dataset_type, meta_root_dir, dataset_root_dir, task_split):
        ...
        task_id2name = {0: "ag_news", 1: "yelp_review_full", 2: "amazon", 3: "yahoo_answers_topics", 4: "dbpedia"}
        task_to_keys = {
            "ag_news": ("text", None),
...
if __name__ == "__main__":
    ...
    d = ContinualFiveLanguage(config, config["dataset_type"], config["meta_root_dir"], config["dataset_root_dir"],
